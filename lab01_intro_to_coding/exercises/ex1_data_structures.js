...
function addAMuseum(museums, newName, newURL, newYear){
  museums[newName] = {}; //create a new object in array with name newName as key
  museums[newName].URL = newURL; // add url
  museums[newName].year = newYear; // add year

  return museums;
}


addAMuseum(museums2, "Asian Art Museum", "asianart.org", 1966);
